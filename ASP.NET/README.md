...
$\sf \color{magenta}ASP.NET$ é um framework de desenvolvimento web para criarmos APIs REST no .NET com C#, ele é extremamente útil para criarmos programas avançados que podem ser usados junto com frontends como $\sf \color{red}\bold{Angular}$ ou $\sf \color{lightblue}\bold{React}$. 
